                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        children: [
                          const Text("!armor blocks:",
                              style: TextStyle(fontSize: 12)),
                          Text("${widget.healthController.absorbedByArmor}",
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                  fontSize: 30,
                                  color: widget.healthController
                                          .armorUsedAgainstTarget()
                                      ? Colors.red
                                      : Colors.blueAccent)),
                          const Text("!new hitpoints:",
                              style: TextStyle(fontSize: 12)),
                          Text(
                              ...
                              style: TextStyle(
                                  fontSize: 24,
                                  color:
                                      widget.healthController.isLosingHealth()
                                          ? Colors.red
                                          : Colors.green)),
                        ],
                      ),
